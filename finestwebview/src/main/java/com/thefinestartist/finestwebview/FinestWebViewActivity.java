...
public class FinestWebViewActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener, View.OnClickListener {
    ...
    protected BFinestWebView webView;
    ...
    protected void bindViews() {
        ...
        webView = new BFinestWebView(this);
    ...
    protected void initializeViews() {
        ...
        { // WebView
            ...
            //注册开放出来的接口
            webView.registerHandler("getWxUserInfo", new BridgeHandler() {
                @Override
                public void handler(String data, CallBackFunction function) {
//                    Log.v("ks", "handler = submitFromWeb, data from web = " + data);
                    function.onCallBack(sp.getString("wxUserInfo", ""));
                }
            });
            webView.registerHandler("wxLogout", new BridgeHandler() {
                @Override
                public void handler(String data, CallBackFunction function) {
                    sp.edit().putString("wxUserInfo", "").commit();
                    function.onCallBack("");
                }
            });
...
//        }
    ...
    public class MyWebViewClient extends WebViewClient {
        private BFinestWebView webView;

        public MyWebViewClient(BFinestWebView webView) {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (BFinestWebView.toLoadJs != null) {
                BridgeUtil.webViewLoadLocalJs(view, BFinestWebView.toLoadJs);
            }
