...
public class BridgeUtil {
	...
	public final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:KsJavascriptBridge._handleMessageFromNative('%s');";
	public final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:KsJavascriptBridge._fetchQueue();";
	public final static String JAVASCRIPT_STR = "javascript:";
	
	public static String parseFunctionName(String jsUrl){
		return jsUrl.replace("javascript:KsJavascriptBridge.", "").replaceAll("\\(.*\\);", "");
	}
