...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLength = (int) a.getDimension(R.styleable.ProgressWheel_barLen, barLength);

        textSize = (int) a.getDimension(R.styleable.ProgressWheel_wtextSize, textSize);

        textColor = (int) a.getColor(R.styleable.ProgressWheel_wtextColor, textColor);

        // if the text is empty , so ignore it
        if (a.hasValue(R.styleable.ProgressWheel_wprogress)) {
            setText(a.getString(R.styleable.ProgressWheel_wprogress));
        }
