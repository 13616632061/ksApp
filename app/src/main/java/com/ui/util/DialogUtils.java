...
public class DialogUtils {
    ...
    public static void ShowInventory(Context mContext, Goods_Inventory goods_inventory){
        ...
        ed_inventory_stock.setSelection(0, ed_inventory_stock.getText().toString().length());
        ...
        mAlertDialog= dialog.setView(view).show();
//        mAlertDialog.getWindow().clearFlags(WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE);
