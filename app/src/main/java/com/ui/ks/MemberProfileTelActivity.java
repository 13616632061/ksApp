...
public class MemberProfileTelActivity extends BaseActivity {
    TextView textView1;
    EditText textView3;
    String tel = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_profile_tel);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                showLoading(MemberProfileTelActivity.this, getString(R.string.str92));
            }
        });
    }
}
