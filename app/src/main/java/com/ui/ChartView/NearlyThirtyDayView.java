 ...
 */
public class NearlyThirtyDayView extends View {
...
//            ,R.mipmap.w18, -1, -1, R.mipmap.w19};
    ...
    public  ArrayList<String> getdataSevenDay_salenum( ArrayList<String> data){
        ...
        TEMP=data;
        if(data.size()>0) {
                maxTemp =Double.parseDouble(getMax(data))+500;
        }
        minTemp =0;
        ITEM_SIZE=30;
        salenum=true;
    ...
    public ArrayList<String> getdataSevenDay_salemoney( ArrayList<String> data){
        ...
        TEMP=data;
        if(data.size()>0) {
            maxTemp =Double.parseDouble(getMax(data))+5000;
        }
        minTemp =0;
        ITEM_SIZE=30;
        salemoney=true;
    ...
    public NearlyThirtyDayView(Context context) {
        this(context, null);
    }
    public NearlyThirtyDayView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }
    public NearlyThirtyDayView(Context context, AttributeSet attrs, int defStyleAttr) {
