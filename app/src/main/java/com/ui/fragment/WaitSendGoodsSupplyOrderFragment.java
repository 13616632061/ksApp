...
public class WaitSendGoodsSupplyOrderFragment extends BaseFragmentMainBranch implements SwipeRefreshLayout.OnRefreshListener {
                        ...
                        if(data!=null){
                            ...
                            for(int i=0;i<data.length();i++){
                                ...
                                for(int j=0;j<goods_info.length();j++){
                                    ...
                                    String quantity=object_goods_info.getString("quantity");
